...
export type FullUserFragment = (
  { __typename?: 'User' }
  & Pick<User, 'id' | 'username' | 'createdAt' | 'updatedAt' | 'email'>
);

export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'points' | 'id' | 'title' | 'createdAt' | 'updatedAt' | 'textSnippet' | 'voteStatus'>
  & { creator: (
    { __typename?: 'User' }
...
export type PostQuery = (
  ...
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'points' | 'id' | 'title' | 'createdAt' | 'updatedAt' | 'voteStatus' | 'text'>
    & { creator: (
      { __typename?: 'User' }
      & Pick<User, 'username' | 'id'>
    ) }
